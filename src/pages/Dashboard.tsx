    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Track your ideas' performance and engagement</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Left Column - Recent Ideas & Joined Challenges */}
                        ...
                        <DialogContent className="bg-card border-border max-w-2xl">
                          ...
                          <form onSubmit={handleSubmitIdea} className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-2 pt-4">
                              <Button type="button" variant="outline" onClick={() => setIsSubmitIdeaOpen(false)}>
                                Cancel
                              </Button>
                              <Button type="submit">
                                Submit Idea
              ...
              <CardContent>
                <div className="space-y-6">
                  {recentIdeas.map((idea) => (
                    <div key={idea.id} className="flex items-center justify-between p-4 bg-background rounded-lg border border-border">
                      <div className="flex-1">
            ...
            <Card className="bg-surface border-border">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Ideas Posted</span>
